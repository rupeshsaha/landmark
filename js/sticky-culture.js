document.addEventListener('DOMContentLoaded', function () {
    ...
    const imageContainer = document.querySelector('.culture-image-container');
    const contentContainer = document.querySelector('.culture-content');

    if (!cultureSection || !imageContainer || !contentContainer) {
        console.log('Culture section elements not found');
        return;
    }
    ...
    function resetStickyState() {
        isSticky = false;
        imageContainer.classList.remove('sticky', 'sticky-animate', 'unstick');
    ...
    function updateSticky() {
        ...
        if (startSticky && !endSticky && !isSticky) {
            ...
            isSticky = false;
            imageContainer.classList.remove('sticky', 'sticky-animate');
